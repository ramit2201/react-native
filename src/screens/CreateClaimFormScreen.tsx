    ...
    <ScrollView className="flex-1 bg-white px-4 py-6">
      ...
      <View className="flex-row justify-around mt-4">
        <TouchableOpacity
          ...
          style={{
            borderColor: isFormFilled ? '#007AFF' : '#FF3B30', // Blue for draft, red for cancel
            backgroundColor: isFormFilled ? '#E5F0FF' : '#FFE5E5', // Light blue for draft, light red for cancel
          }}>
          <Text
            className="font-bold text-lg"
            style={{color: isFormFilled ? '#007AFF' : '#FF3B30'}}>
